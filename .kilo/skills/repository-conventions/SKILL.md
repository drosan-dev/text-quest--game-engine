...
description: This skill should be used when creating commits or writing tests in this repository, especially to enforce Russian commit messages, Russian test summary documentation, and Arrange/Act/Assert test structure.
---
...
Use this skill when work touches repository-specific authoring conventions. Apply these rules for commits and automated tests to keep the project consistent.

## Commit Messages

1. Write commit messages in Russian for this repository.
2. Keep the message concise and aligned with the repository change.
