...
Этот документ фиксирует поддерживаемый JSON-формат квеста для текущего MVP. Он описывает фактический контракт, который понимают `TextQuest.Content.Json`, runtime и CLI.
